    ...
    <div>
        ...
        <div class="new-layer">
            <el-link type="primary" :underline="false">
                <span>我的图层</span>
                <i class="el-icon-circle-plus-outline add-btn" @click="addOneLayer"></i>
            </el-link>
    ...
    export default {
        ...
        data() {
            return {
                ...
                layerList:[
                    {
                        "name": "图层1","icons":"el-icon-share",active:false,show:true,children:[]
                    },
                    {
                        "name": "图层2","icons":"el-icon-share",active:false,show:true,children:[]
                    }
                ]
            }
        },
        ...
        methods:{
            ...
            addOneLayer () {
                let obj = {};
                obj = {"name": "图层3","icons":"el-icon-share",active:false,show:true,children:[]};
